...
public class ReportesFragment extends Fragment {
     ...
     *
     * @param paramm1 Parameter 1.
     * @param param2 Parameter 2.
     * @return A new instance of fragment ReportesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ReportesFragment newInstance(String paramm1, String param2) {
        ReportesFragment fragment = new ReportesFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, paramm1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParamm1 = getArguments().getString(ARG_PARAM1);
